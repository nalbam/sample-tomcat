...
@Library("github.com/nalbam/jenkinsfiles")
...
podTemplate(label: label, containers: [
  containerTemplate(name: "builder", image: "opspresso/builder:v0.7.76-kube", command: "cat", ttyEnabled: true, alwaysPullImage: true),
